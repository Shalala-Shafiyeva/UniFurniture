...
function AboutNumber() {
    ...
    useEffect(() => {
      const fetchTitles = async () => {
        try {
          const response = await fetch(
            "http://localhost:8000/api/dashboard/about/number-title",
      ...
      const fetchSubtitles = async () => {
        try {
          const response = await fetch(
            "http://localhost:8000/api/dashboard/about/number-subtitle",
            { method: "GET", headers: { "Content-Type": "application/json" } }
          );
          const result = await response.json();
    ...
    const handleTitleFormSubmit = async (e) => {
      ...
      try {
        const response = await fetch(
          "http://localhost:8000/api/dashboard/about/number-title/create",
          {
            method: "POST",
            body: formData,
          }
    ...
    const handleSubtitleFormSubmit = async (e) => {
      ...
      try {
        const response = await fetch(
          "http://localhost:8000/api/dashboard/about/number-subtitle/create",
          {
            method: "POST",
            body: formData,
          }
    ...
    const handleDeleteTitle = async (id) => {
      try {
        const response = await fetch(
          `http://localhost:8000/api/dashboard/about/number-title/delete/${id}`,
    ...
    const handleDeleteMember = async (id) => {
      try {
        const response = await fetch(
          `http://localhost:8000/api/dashboard/about/number-subtitle/delete/${id}`,
          { method: "DELETE", headers: { "Content-Type": "application/json" } }
        );
        const result = await response.json();
    ...
    const handlePublishTitle = async (id) => {
      try {
        const response = await fetch(
          `http://localhost:8000/api/dashboard/about/number-title/publish/${id}`,
          {
            method: "POST",
